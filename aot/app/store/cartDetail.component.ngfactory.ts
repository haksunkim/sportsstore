...
export class View_CartDetailComponent0 extends import1.AppView<import0.CartDetailComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_58 = this.renderer.createText(this._el_57,'Checkout',(null as any));
...
class View_CartDetailComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_3 = this.renderer.createText(this._el_2,'Your cart is empty',(null as any));
    this._text_4 = this.renderer.createText(this._el_0,'\n      ',(null as any));
