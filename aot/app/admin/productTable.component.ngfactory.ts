...
export class View_ProductTableComponent0 extends import1.AppView<import0.ProductTableComponent> {
  ...
  _text_22:any;
  _el_23:any;
  _RouterLink_23_3:import11.Wrapper_RouterLink;
  _text_24:any;
  _text_25:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._NgFor_19_6 = new import10.Wrapper_NgFor(this._vc_19.vcRef,this._TemplateRef_19_5,this.parentView.injectorGet(import14.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._el_23 = import3.createRenderElement(this.renderer,parentRenderNode,'button',new import3.InlineArray4(4,'class','btn btn-primary','routerLink','/admin/main/products/create'),(null as any));
    this._RouterLink_23_3 = new import11.Wrapper_RouterLink(this.parentView.injectorGet(import15.Router,this.parentIndex),this.parentView.injectorGet(import16.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import17.LocationStrategy,this.parentIndex));
    this._text_24 = this.renderer.createText(this._el_23,'Create New Product',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.NgFor) && (19 === requestNodeIndex))) { return this._NgFor_19_6.context; }
    if (((token === import20.RouterLink) && ((23 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._RouterLink_23_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_19_0_0:any = this.context.getProducts();
    ...
    const currVal_23_0_0:any = '/admin/main/products/create';
    this._RouterLink_23_3.check_routerLink(currVal_23_0_0,throwOnChange,false);
    this._RouterLink_23_3.ngDoCheck(this,this._el_23,throwOnChange);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import1.AppView<any> {
    if ((nodeIndex == 19)) { return new View_ProductTableComponent1(this.viewUtils,this,19,this._anchor_19,this._vc_19); }
    return (null as any);
  }
  handleEvent_23(eventName:string,$event:any):boolean {
    this.markPathToRootAsCheckOnce();
    var result:boolean = true;
    result = (this._RouterLink_23_3.handleEvent(eventName,$event) && result);
    return result;
  }
}
class View_ProductTableComponent1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_26:any = import3.inlineInterpolate(1,'',this.context.$implicit.cateogry,'');
