...
export var View_ProductEditorComponent0 = (function (_super) {
    ...
    View_ProductEditorComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._DefaultValueAccessor_37_3 = new import13.Wrapper_DefaultValueAccessor(this.renderer, new import16.ElementRef(this._el_37));
        ...
        this._RouterLink_43_3 = new import15.Wrapper_RouterLink(this.parentView.injectorGet(import9.Router, this.parentIndex), this.parentView.injectorGet(import10.ActivatedRoute, this.parentIndex), this.parentView.injectorGet(import17.LocationStrategy, this.parentIndex));
        this._text_44 = this.renderer.createText(this._el_43, 'Cancel', null);
    ...
    View_ProductEditorComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_37_1_0 = 'price';
        this._NgModel_37_5.check_name(currVal_37_1_0, throwOnChange, false);
        var currVal_37_1_1 = this.context.product.price;
        ...
        var currVal_43_0_0 = '/admin/main/products';
        ...
        if (import3.checkBinding(throwOnChange, this._expr_73, currVal_73)) {
            this.renderer.setElementClass(this._el_40, 'btn-warning', currVal_73);
            this._expr_73 = currVal_73;
        }
        var currVal_74 = import3.inlineInterpolate(1, '', (this.context.editing ? 'Save' : 'Create'), '');
    ...
    View_ProductEditorComponent0.prototype.handleEvent_37 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
    ...
    View_ProductEditorComponent0.prototype.handleEvent_43 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
