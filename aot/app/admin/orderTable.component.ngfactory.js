...
export var View_OrderTableComponent0 = (function (_super) {
    ...
    View_OrderTableComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_16 = import3.createRenderElement(this.renderer, this._el_12, 'th', import3.EMPTY_INLINE_ARRAY, null);
        this._text_17 = this.renderer.createText(this._el_16, 'Zip', null);
        this._el_18 = import3.createRenderElement(this.renderer, this._el_12, 'th', new import3.InlineArray2(2, 'colspan', '2'), null);
        this._text_19 = this.renderer.createText(this._el_18, 'Cart', null);
        ...
        this._el_24 = import3.createRenderElement(this.renderer, this._el_8, 'tbody', import3.EMPTY_INLINE_ARRAY, null);
    ...
    View_OrderTableComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_26_0_0 = (this.context.getOrders().length == 0);
        ...
        var currVal_28_0_0 = this.context.getOrders();
    ...
    View_OrderTableComponent0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 26)) {
            return new View_OrderTableComponent1(this.viewUtils, this, 26, this._anchor_26, this._vc_26);
        }
        if ((nodeIndex == 28)) {
            return new View_OrderTableComponent2(this.viewUtils, this, 28, this._anchor_28, this._vc_28);
        }
        return null;
    };
...
var View_OrderTableComponent2 = (function (_super) {
    ...
    View_OrderTableComponent2.prototype.createInternal = function (rootSelector) {
        ...
        this._text_16 = this.renderer.createText(this._el_15, 'Ship', null);
